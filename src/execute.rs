...
use cosmwasm_std::{Addr, DepsMut, Env, MessageInfo, Timestamp, Deps};
...
pub fn execute(
    ...
    let api = deps.api;
        ...
        ExecuteMsg::AcceptOffer { id } => execute_accept_offer(deps, id),
...
fn execute_accept_offer(_deps:DepsMut, _id:u8) -> Result<Response, ContractError> {
    todo!()
}
